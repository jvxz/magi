...
<template>
  <div class="flex h-screen items-center justify-center">
    <div class="bg-card-lighter py-12 rounded container flex size-fit w-lg shadow-xl">
        ...
        <div class="px-12 flex flex-col gap-4 items-center justify-center">
          ...
          >
            <UAutocompleteRoot v-model:model-value="r$.$value.homeserver" class="group" reset-search-term-on-blur>
              <UAutocompleteAnchor class="bg-card border-muted h-10 group-data-[error]:border-danger">
