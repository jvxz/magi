...
const interactiveStyles = {
  ...
  variant: {
    ...
    soft: 'border-border/90 text-muted-foreground hover:text-foreground hover:bg-muted/90 active:bg-muted/75 hover:border-border active:border-border border bg-input',
  },
}
...
const overlayStyles
  = 'duration-75 data-[state=open]:animate-in data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-overlay backdrop-blur-xs'
